...
const (
	...
	ModePrep2CacheSearchOnly   = Mode(C.OCI_PREP2_CACHE_SEARCHONLY)
	ModePrep2GetPlsqlWarnings  = Mode(C.OCI_PREP2_GET_PLSQL_WARNINGS)
	ModePrep2ImplResultsClient = Mode(C.OCI_PREP2_IMPL_RESULTS_CLIENT)
	ModeStrlsCacheDelete       = Mode(C.OCI_STRLS_CACHE_DELETE)
)
